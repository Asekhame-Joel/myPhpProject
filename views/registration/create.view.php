...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Register a New User</h2>
  </div>
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <div>
        ...
        <?php  if(isset($errors['name'])){ ?>
              <p class="text-red-500 text-md"> <?php echo $errors['name'] ?></p>
           <?php } ?>
      </div> 
    <div>
        ...
        <?php  if(isset($errors['email'])){ ?>
              <p class="text-red-500 text-md"> <?php echo $errors['email'] ?></p>
           <?php } ?>
      </div>
      ...
      <div>
        ...
        <?php  if(isset($errors['password'])){ ?>
              <p class="text-red-500 text-md"> <?php echo $errors['password'] ?></p>
           <?php } ?>
